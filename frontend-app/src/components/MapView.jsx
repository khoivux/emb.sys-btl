...
const MapView = ({ drones, selectionMode = false, selectedDrones = [], onDroneSelect, ghostPositions = [], showLabels = true, focusedDroneId = null, onDroneFocus, targetCenter = null, onMapClick = null }) => {
